...
public class AccountUtils {
     ...
     */
    public <T> T getAccount(Integer sendAccount, String nacosKey, String prefix, Class<T> clazz) {
        String accountValues = config.getProperty(nacosKey, HermesConstant.CONFIG_CENTER_DEFAULT_VALUE_JSON_ARRAY);
